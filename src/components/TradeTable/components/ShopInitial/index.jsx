...
import { getRawMaterials, tradeWithGamein } from "../../../../apis/trade";
    ...
    <div className="shop-initial">
        ...
        <div className="shop-initial__list">
          {data?.myRegion?.map((material) => (
            ...
            >
              ...
              <div className="shop-initial__material-name">{material.name}</div>
            </div>
          ))}
        </div>
      ...
      >
        <div className="shop-modal">
          <div className="shop-modal__modal">
            <div className="shop-modal__title">فروشگاه گیمین</div>
            <div className="shop-modal__body">
              <div className="shop-modal__close" onClick={() => setOpen(false)}>
                <CloseIcon />
              </div>
              <img
