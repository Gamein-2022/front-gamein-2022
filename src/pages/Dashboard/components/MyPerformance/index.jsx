...
function MyPerformance() {
  return (
    <>
      <div style={{ margin: 32, fontWeight: 600 }}>
        در لحظات پایانی بازی رتبه‌ها قابل نمایش نیست...
      </div>
      <div style={{ display: "flex", justifyContent: "center" }}>
        <img
          style={{ margin: "auto", textAlign: "center", width: 128 }}
          src={eye}
          alt="no see"
        />
      </div>
      <div className="my-performance__top">
        <div className="my-performance__item">
          ...
          <div className="my-performance__item-value">***,***,***</div>
        </div>
        {/* <div className="my-performance__item">
...
{performanceInfo?.brand}
        ...
        <div className="my-performance__item">
          <div className="my-performance__item-title">رتبه شما</div>
          <div className="my-performance__item-value">***</div>
        </div>
      </div>
      <div className="my-performance__tables">
        <div className="my-performance__table">
          ...
          <>
            ...
            {[1, 2, 3].map((item) => (
              <div className="my-performance__table-row">
                <div className="my-performance__table-right">******</div>
                <div className="my-performance__table-left">***,***,***</div>
              </div>
            ))}
          </>
        </div>
